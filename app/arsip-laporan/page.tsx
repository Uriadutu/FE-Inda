...
const page = () => {
  ...
  const getArsip = async () => {
    try {
      const response = await axios.get(`${Config.ipPUBLIC}/arsip`);
      ...
      <table className="table-auto mt-3 w-full border-collapse border border-gray-300">
        <thead>
          <tr className="bg-gray-200">
            <th className="border border-gray-300 px-4 py-2 whitespace-nowrap">No</th>
            <th className="border border-gray-300 px-4 py-2 whitespace-nowrap text-left">
              Nama Drilling Report
            </th>
            <th className="border border-gray-300 px-4 py-2 whitespace-nowrap text-left">Tanggal</th>
            <th className="border border-gray-300 px-4 py-2 whitespace-nowrap">Aksi</th>
          </tr>
        </thead>
        <tbody>
